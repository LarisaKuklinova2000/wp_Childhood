        ...
        <div class="aboutus" id="aboutus">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="subtitle">
                            <?php the_field('story_first', 2); ?>
                        </div>
                        <div class="aboutus__text">
                            <?php the_field('story_first-descr', 2); ?>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <img class="aboutus__img" src="<?php the_field('story_first-img', 2); ?>" alt="мир детства">
                    </div>
                </div>

                <div class="row">
                    <div class="col-lg-6">
                        <img class="aboutus__img" src="<?php the_field('story_second-img', 2); ?>" alt="мир детства">
                    </div>
                    <div class="col-lg-6">
                        <div class="subtitle">
                            <?php the_field('story_second', 2); ?>
                        </div>
                        <div class="aboutus__text">
                            <?php the_field('story_second-descr', 2); ?>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="subtitle">
                            <?php the_field('story_third', 2); ?>
                        </div>
                        <div class="aboutus__text">
                            <?php the_field('story_third-descr', 2); ?>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <img class="aboutus__img" src="<?php the_field('story_third-img', 2); ?>" alt="мир детства">
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="contacts__descr underlined">
                            <?php the_field('adress_descr', 2); ?>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div id="map" class="contacts__map">
                            <div style="width:100%;height:400px;margin-left:auto;margin-right:auto" class="wp-block-gutenberg-yandex-block-map" data-params="{&quot;height&quot;:&quot;400px&quot;,&quot;width&quot;:&quot;100%&quot;,&quot;lat&quot;:55.738164984877976,&quot;lon&quot;:37.50722765922547,&quot;pm_lat&quot;:53.918777,&quot;pm_lon&quot;:27.562007,&quot;pm_balloon&quot;:&quot;&quot;,&quot;pm_hint&quot;:&quot;&quot;,&quot;zoom&quot;:11,&quot;has_placemark&quot;:false}"></div>
                        </div>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class='contacts__feed'>
                            <?php echo do_shortcode( '[contact-form-7 id="148" title="Форма отзывов"]' ) ?>
                        </div>
                    </div>
                </div>
                <div class="row mt70">
